import { isRef, ref, watchEffect, computed, createApp, reactive, getCurrentInstance, customRef, onMounted, onUpdated, watch, unref, markRaw } from 'vue-demi';
...
function useCssVar(prop, el, { window = defaultWindow } = {}) {
    var _a;
    const variable = ref('');
    const _el = ref(el || ((_a = window === null || window === void 0 ? void 0 : window.document) === null || _a === void 0 ? void 0 : _a.documentElement));
    watch(_el, () => {
        if (_el.value && window)
...
function useFullscreen(target, options = {}) {
    ...
    async function exit() {
        if (!isSupported)
            return;
        if (document === null || document === void 0 ? void 0 : document[map[2]])
